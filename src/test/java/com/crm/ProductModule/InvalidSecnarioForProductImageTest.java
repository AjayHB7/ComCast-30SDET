...
public class InvalidSecnarioForProductImageTest 
{
	@Test
	public void invalidSecnarioForProductImage() throws Throwable
	{
		...
		String productname = elib.readDataFromExcel("product", 28, 2);
		String pathoffile = elib.readDataFromExcel("product", 28, 3);
		...
		//upload the file 
		driver.findElement(By.xpath("//input[@id='my_file_element']")).sendKeys(pathoffile);
