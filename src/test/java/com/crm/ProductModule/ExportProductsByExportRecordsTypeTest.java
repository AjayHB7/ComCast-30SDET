...
public class ExportProductsByExportRecordsTypeTest 
{
	@Test
	public void exportProductsByExportAllData() throws Throwable
	{
		...
		driver.findElement(By.xpath("//input[@name='export_data' and @value='all']")).click();
